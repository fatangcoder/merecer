...
if(isset($_GET['view_catg_men'])){

include("view_catg_men.php");

}

if(isset($_GET['view_catg_women'])){

include("view_catg_women.php");

}

if(isset($_GET['view_catg_business'])){

include("view_catg_business.php");

}

if(isset($_GET['edit_catg_men'])){

include("edit_catg_men.php");

}
if(isset($_GET['edit_catg_women'])){

include("edit_catg_women.php");

}
if(isset($_GET['edit_catg_business'])){

include("edit_catg_business.php");

}
if(isset($_GET['view_sec_explore'])){

include("view_sec_explore.php");

}
if(isset($_GET['edit_sec_explore'])){

include("edit_sec_explore.php");

}

if(isset($_GET['view_catg_bag'])){

include("view_catg_bag.php");

}
if(isset($_GET['edit_catg_bag'])){

include("edit_catg_bag.php");

}

if(isset($_GET['view_catg_lapbag'])){

include("view_catg_lapbag.php");

}
if(isset($_GET['edit_catg_lapbag'])){

include("edit_catg_lapbag.php");

}

if(isset($_GET['view_catg_wallet'])){

include("view_catg_wallet.php");

}
if(isset($_GET['edit_catg_wallet'])){

include("edit_catg_wallet.php");

}
if(isset($_GET['view_catg_exclusive'])){

include("view_catg_exclusive.php");

}
if(isset($_GET['edit_catg_exclusive'])){

include("edit_catg_exclusive.php");
